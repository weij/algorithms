...
module IIDWorks
  class TestQuickSort < Minitest::Test
    ...
    def test_3_parameters_insertion_sort
      ...
      assert_equal @sorted, QuickSort.insertion_sort(@a, 0, 10)      	
    end
    ...
    def test_cutoff_to_insertion_sort
      ...
      assert_equal sorted, QuickSort.sort_internal(quicksort_example, 0, 15)          
    end
  ...
  class BenchQuickSort < Minitest::Benchmark
    ...
    def bench_cutoff_algorithm 
    	assert_performance_linear 0.99 do |n|
    	  a = Array.new(n) { rand }
    	  QuickSort.sort_internal(a, 0, a.size-1)
      end
  
    	assert_performance_linear 0.99 do |n|
    	  a = Array.new(n) { rand }
    	  QuickSort.sort_internal(a, 0, a.size-1, cutoff: 10)
      end    
    end 
  end
end